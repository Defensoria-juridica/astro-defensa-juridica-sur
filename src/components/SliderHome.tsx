...
import slider01 from "../assets/images/portada11.webp";
...
export const SliderHome: React.FC<SliderHomeProps> = ({
    ...
    return (
        <section
            className={`relative w-full h-[120vh] overflow-hidden ${className}`}
                    ...
                    {isResponsiveImage(currentSlide.image) ? (
                        <picture className="absolute inset-0 bg-black flex items-center justify-center">
                           ...
                           <img
                             ...
                             className={
                             currentSlide.id === 1
                             ?"w-full h-full object-cover object-[center_55%]"
